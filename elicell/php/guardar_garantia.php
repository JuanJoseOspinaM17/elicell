...
$nombre_cliente = post_value('nombre_cliente');

$telefono_cliente = post_value('telefono_cliente');

$tipo_dispositivo = post_value('tipo_dispositivo');

$marca = post_value('marca');

$modelo = post_value('modelo');

$imei = post_value('imei');

$falla = post_value('falla');
...
if (!in_array($unidad_garantia, $unidades_validas, true)) {
...
if (
    !$fechaObjeto ||
    $fechaObjeto->format('Y-m-d') !== $fecha_entrada
) {
